...
class VecEnv(ABC):
    ...
    def __init__(self, num_envs, mdp_info): #  observation_space, action_space
        self.num_envs = num_envs
        self._mdp_info = mdp_info
        self.observation_space = self.info.observation_space
        self.action_space = self.info.action_space
